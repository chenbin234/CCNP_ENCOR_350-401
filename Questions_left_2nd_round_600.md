...
| 3    | Q521 DNA                   |                                                              |
| 4    | Q520 CoPP                  | ??????????                                                   |
| 4    | Q519 WLC                   | Wireless access points use the DHCPv6 option 52 (RFC 5417) to supply the IPv6 management interface addresses of the primary, secondary, and tertiary wireless controllers. |
| 4    | Q517 ACL                   |                                                              |
| 4    | Q515 BGP                   | ??????????                                                   |
| 3    | Q506 OSPF                  |                                                              |
| 3    | Q505 WebAuth               |                                                              |
...
| 3    | Q497 HSRP                  |                                                              |
| 3    | Q494 ERSPAN                |                                                              |
| 4    | Q489 IGMP                  | The router with the lowest IP address is elected the IGMP Querier when more than one router is in the same LAN segment |
| 4    | Q488 SD-Access             |                                                              |
| 3    | Q486 SD-WAN                |                                                              |
| 3    | Q483 Wireless              |                                                              |
| 3    | Q482 LISP                  |                                                              |
...
| 4    | Q435 VRF                   | ??????????                                                   |
| 3    | Q434 ERSPAN                |                                                              |
| 4    | Q430 SD-WAN                | TLOC for the overlay acts as IP next hop for the underlay    |
| 4    | Q428 BGP                   | ??????????                                                   |
| 3    | Q427 JWT                   |                                                              |
| 3    | Q426 API                   |                                                              |
| 4    | Q425 prefix list           |                                                              |
